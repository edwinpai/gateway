...
declare global {
  interface Window {
    __EDWINPAI_ASSISTANT_NAME__?: string;
    __EDWINPAI_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__EDWINPAI_ASSISTANT_NAME__,
    avatar: window.__EDWINPAI_ASSISTANT_AVATAR__,
  });
}
