...
function listConfiguredAccountIds(cfg: EdwinPAIConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: EdwinPAIConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: EdwinPAIConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: EdwinPAIConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: EdwinPAIConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: EdwinPAIConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: EdwinPAIConfig): ResolvedWhatsAppAccount[] {
