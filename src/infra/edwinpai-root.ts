...
const CORE_PACKAGE_NAMES = new Set(["edwinpai", "@edwinpai/edwinpai"]);
...
export async function resolveEdwinPAIPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveEdwinPAIPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
