...
/**
 * SECURITY: IPv6 transition mechanism prefixes that can tunnel to private
 * IPv4 addresses, bypassing SSRF protections. See upstream fix for details.
 */
const TRANSITION_IPV6_PREFIXES = [
  "64:ff9b:", // NAT64 well-known prefix (RFC 6052)
  "64:ff9b:1:", // NAT64 local-use prefix (RFC 8215)
  "2002:", // 6to4 (RFC 3056) — encapsulates arbitrary IPv4
  "2001:0000:", // Teredo (RFC 4380) — embeds IPv4 in client address
  "2001:0:", // Teredo (compressed form)
  "2001::", // Teredo (fully compressed)
];
...
export function isPrivateIpAddress(address: string): boolean {
  ...
  if (normalized.includes(":")) {
    ...
    // SECURITY: Block IPv6 transition addresses that can tunnel to private IPv4
    if (TRANSITION_IPV6_PREFIXES.some((prefix) => normalized.startsWith(prefix))) {
      return true;
    }
    return false;
  }
