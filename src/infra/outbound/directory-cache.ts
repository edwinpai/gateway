...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: EdwinPAIConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: EdwinPAIConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: EdwinPAIConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: EdwinPAIConfig): void {
