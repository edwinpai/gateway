...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "edwinpai-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveEdwinPAIPackageRoot } = await import("./edwinpai-root.js");
    ...
    vi.mocked(resolveEdwinPAIPackageRoot).mockResolvedValue("/opt/edwinpai");
