...
function resolveAnthropicDefaultAuthMode(cfg: EdwinPAIConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyTalkApiKey(config: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyModelDefaults(cfg: EdwinPAIConfig): EdwinPAIConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyLoggingDefaults(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyContextPruningDefaults(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyCompactionDefaults(cfg: EdwinPAIConfig): EdwinPAIConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
