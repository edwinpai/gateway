...
export const RuntimeAttachmentPolicySchema = z.union([
  z.literal("mounted-only"),
  z.literal("attach-on-demand"),
]);
  ...
  .object({
    ...
    subagents: z
      .object({
        ...
        profileBindings: z.record(z.string(), z.string()).optional(),
        profiles: z
          .record(
            z.string(),
            z
              .object({
                ...
                runtimeAttachmentPolicy: RuntimeAttachmentPolicySchema.optional(),
              })
              .strict(),
          )
          .optional(),
