import type { EdwinPAIConfig } from "./config.js";
...
function isTelegramConfigured(cfg: EdwinPAIConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: EdwinPAIConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: EdwinPAIConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: EdwinPAIConfig): boolean {
...
function isIMessageConfigured(cfg: EdwinPAIConfig): boolean {
...
function isWhatsAppConfigured(cfg: EdwinPAIConfig): boolean {
...
function isGenericChannelConfigured(cfg: EdwinPAIConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: EdwinPAIConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: EdwinPAIConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: EdwinPAIConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: EdwinPAIConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: EdwinPAIConfig, pluginId: string): EdwinPAIConfig {
...
function enablePluginEntry(cfg: EdwinPAIConfig, pluginId: string): EdwinPAIConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
