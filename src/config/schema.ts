...
import { EdwinPAISchema } from "./zod-schema.js";
...
export type ConfigSchema = ReturnType<typeof EdwinPAISchema.toJSONSchema>;
...
const FIELD_LABELS: Record<string, string> = {
  ...
  "security.requireSignedRequests": "Require Signed Requests",
  "security.requirePermissionTokenProofs": "Require Permission Token Proofs",
  "security.permissionTokenProofUrl": "Permission Token Proof URL",
  "security.permissionTokenProofTimeoutMs": "Permission Token Proof Timeout (ms)",
  "security.authorizedKeys": "Authorized Signing Keys",
  "security.subscription.required": "Require Subscription Token",
  "security.subscription.requiredScope": "Subscription Token Scope",
...
const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when EdwinPAI writes the config.",
  ...
  "gateway.controlUi.basePath":
    "Optional URL prefix where the Control UI is served (e.g. /edwinpai).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $EDWINPAI_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.edwinpai/memory/{agentId}.sqlite).",
  ...
  "memory.backend": 'Memory backend ("builtin" for EdwinPAI embeddings, "qmd" for QMD sidecar).',
  ...
  "plugins.installs":
    "CLI-managed install metadata (used by `edwinpai plugins update` to locate install sources).",
  "plugins.installs.*.source": 'Install source ("npm", "archive", or "path").',
  "plugins.installs.*.spec": "Original npm spec used for install (if source is npm).",
  "plugins.installs.*.sourcePath": "Original archive/path used for install (if any).",
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.edwinpai/extensions/<id>).",
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.controlUi.basePath": "/edwinpai",
  "gateway.controlUi.root": "dist/control-ui",
  "gateway.controlUi.allowedOrigins": "https://control.example.com",
  "channels.mattermost.baseUrl": "https://chat.example.com",
  "agents.list[].identity.avatar": "avatars/edwinpai.png",
};
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const schema = EdwinPAISchema.toJSONSchema({
    target: "draft-07",
    unrepresentable: "any",
  });
  schema.title = "EdwinPAIConfig";
