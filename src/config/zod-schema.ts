...
export const EdwinPAISchema = z
  .object({
    ...
    security: z
      .object({
        requireSignedRequests: z.boolean().optional(),
        requireSignedConfig: z.boolean().optional(),
        requirePermissionTokenProofs: z.boolean().optional(),
        permissionTokenProofUrl: z.string().optional(),
        permissionTokenProofTimeoutMs: z.number().int().min(1000).optional(),
        authorizedKeys: z.array(z.string()).optional(),
        subscription: z
          .object({
