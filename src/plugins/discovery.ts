...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @edwinpai/voice-call -> voice-call).
...
export function discoverEdwinPAIPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".edwinpai", "extensions")];
