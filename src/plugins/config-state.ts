...
export const BUNDLED_ENABLED_BY_DEFAULT = new Set<string>(["provider-auth"]);
...
const hasExplicitMemorySlot = (plugins?: EdwinPAIConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: EdwinPAIConfig["plugins"]) =>
  Boolean(
    plugins?.entries &&
    (Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core") ||
      Object.prototype.hasOwnProperty.call(plugins.entries, "shad-context")),
  );

const hasExplicitPluginConfig = (plugins?: EdwinPAIConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
