...
import type { GatewayBindMode, GatewayTailscaleMode, EdwinPAIConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      [
        "Docs:",
        "https://docs.edwinpai.com/gateway/tailscale",
        "https://docs.edwinpai.com/web",
      ].join("\n"),
      "Tailscale",
    );
