...
export async function finalizeOnboardingWizard(
  ...
  await prompter.note(
    [
      ...
      "Docs: https://docs.edwinpai.com/concepts/agent-workspace",
    ].join("\n"),
    "Workspace backup",
  );

  await prompter.note(
    "Running agents on your computer is risky — harden your setup: https://docs.edwinpai.com/security",
    "Security",
  );
  ...
  await prompter.note(
    hasWebSearchKey
      ...
      : [
          ...
          "",
          "EdwinPAI uses Brave Search for the `web_search` tool. Without a Brave Search API key, web search won’t work.",
          "",
          "Set it up interactively:",
          `- Run: ${formatCliCommand("edwinpai configure --section web")}`,
  ...
  await prompter.note(
    'What now: https://edwinpai.com/showcase ("What People Are Building").',
    "What now",
  );
