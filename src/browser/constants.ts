export const DEFAULT_EDWINPAI_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = false;
export const DEFAULT_EDWINPAI_BROWSER_COLOR = "#FF4500";
export const DEFAULT_EDWINPAI_BROWSER_PROFILE_NAME = "edwinpai";
