const DEFAULT_TAGLINE = "All your chats, one EdwinPAI.";
...
const TAGLINES: string[] = [
  ...
  "I'll supercharge your workflow like a lightning bolt: fast, electric, effective.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.EDWINPAI_TAGLINE_INDEX ?? env?.EDWIN_TAGLINE_INDEX;
