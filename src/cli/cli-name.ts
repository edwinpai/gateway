...
export const DEFAULT_CLI_NAME = "edwinpai";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "edwinpai"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(edwinpai|edwinpai)\b/;
