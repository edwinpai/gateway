...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.edwinpai.com/cli/onboard")}\n`,
    )
    .option("--workspace <dir>", "Agent workspace directory (default: ~/.edwinpai/workspace)")
    ...
    .option("--skip-ui", "Skip Desktop/TUI prompts")
