...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof EdwinPAIConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: EdwinPAIConfig; env: NodeJS.ProcessEnv }): {
  cfg: EdwinPAIConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
