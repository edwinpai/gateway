...
import type { EdwinPAIPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: EdwinPAIPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: EdwinPAIPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
