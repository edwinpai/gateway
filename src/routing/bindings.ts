...
export function listBindings(cfg: EdwinPAIConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: EdwinPAIConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: EdwinPAIConfig) {
