...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@edwinpai", { botUsername: "edwinpai" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@edwinpai args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "edwinpai" })).toBe(
      "/help@otherbot",
    );
  });
