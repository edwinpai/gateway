...
export const A2UI_PATH = "/__edwin__/a2ui";

export const CANVAS_HOST_PATH = "/__edwin__/canvas";

export const CANVAS_WS_PATH = "/__edwin__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.edwinpaiCanvasA2UIAction.postMessage(...)
  // - Android: window.edwinpaiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["edwinpaiCanvasA2UIAction"];
