...
export function listSignalAccountIds(cfg: EdwinPAIConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: EdwinPAIConfig): string {
...
function mergeSignalAccountConfig(cfg: EdwinPAIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: EdwinPAIConfig): ResolvedSignalAccount[] {
