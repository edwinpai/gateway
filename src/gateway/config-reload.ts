...
import type { EdwinPAIConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: EdwinPAIConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: EdwinPAIConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: EdwinPAIConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: EdwinPAIConfig) => void;
  log: {
