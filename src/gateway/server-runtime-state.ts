...
import { resolveBsvAuth } from "./bsv-auth.js";
...
export async function createGatewayRuntimeState(params: {
  cfg: import("../config/config.js").EdwinPAIConfig;
  bindHost: string;
  port: number;
  ...
  const resolvedBsvAuth = resolveBsvAuth({
    bsvAuthConfig: params.cfg.gateway?.bsvAuth,
  });
