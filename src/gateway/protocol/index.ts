...
import {
  ...
  type SessionsTasksListParams,
  SessionsTasksListParamsSchema,
  type SessionsTasksCreateParams,
  SessionsTasksCreateParamsSchema,
  type SessionsTasksUpdateParams,
  SessionsTasksUpdateParamsSchema,
  type SessionsTasksDeleteParams,
  SessionsTasksDeleteParamsSchema,
  type SessionsTasksExecuteParams,
  SessionsTasksExecuteParamsSchema,
  type SessionsTasksSelectParams,
  SessionsTasksSelectParamsSchema,
  type SessionsTasksReorderParams,
  SessionsTasksReorderParamsSchema,
  type SessionsTaskGetParams,
  SessionsTaskGetParamsSchema,
  type SessionsTaskUpdateParams,
  SessionsTaskUpdateParamsSchema,
  type SessionsTaskActionParams,
  SessionsTaskActionParamsSchema,
...
export const validateSessionsTasksListParams = ajv.compile<SessionsTasksListParams>(
  SessionsTasksListParamsSchema,
);
export const validateSessionsTasksCreateParams = ajv.compile<SessionsTasksCreateParams>(
  SessionsTasksCreateParamsSchema,
);
export const validateSessionsTasksUpdateParams = ajv.compile<SessionsTasksUpdateParams>(
  SessionsTasksUpdateParamsSchema,
);
export const validateSessionsTasksDeleteParams = ajv.compile<SessionsTasksDeleteParams>(
  SessionsTasksDeleteParamsSchema,
);
export const validateSessionsTasksExecuteParams = ajv.compile<SessionsTasksExecuteParams>(
  SessionsTasksExecuteParamsSchema,
);
export const validateSessionsTasksSelectParams = ajv.compile<SessionsTasksSelectParams>(
  SessionsTasksSelectParamsSchema,
);
export const validateSessionsTasksReorderParams = ajv.compile<SessionsTasksReorderParams>(
  SessionsTasksReorderParamsSchema,
);
export const validateSessionsTaskGetParams = ajv.compile<SessionsTaskGetParams>(
  SessionsTaskGetParamsSchema,
);
export const validateSessionsTaskUpdateParams = ajv.compile<SessionsTaskUpdateParams>(
  SessionsTaskUpdateParamsSchema,
);
export const validateSessionsTaskActionParams = ajv.compile<SessionsTaskActionParams>(
  SessionsTaskActionParamsSchema,
);
