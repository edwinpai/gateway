...
export type GatewayRequestHandlerOptions = {
  ...
  respond: RespondFn;
  context: GatewayRequestContext;
  /** Compressed secp256k1 public key (hex) from BSV-verified signed envelope, if present */
  verifiedSignerKey?: string;
  /** The verified SignedEnvelope from the BSV-authenticated request, if present */
