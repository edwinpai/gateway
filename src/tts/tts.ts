...
export function resolveTtsConfig(cfg: EdwinPAIConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.EDWINPAI_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: EdwinPAIConfig): string | undefined {
...
export function resolveTtsApiKey(
  ...
  if (provider === "elevenlabs") {
    return (
      ...
      getCredentialFromVaultSync("elevenlabs-api-key") ||
  ...
  if (provider === "openai") {
    return (
      ...
      getCredentialFromVaultSync("openai-api-key") ||
