...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "edwinpai-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<EdwinPAIConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<EdwinPAIConfig["telegram"]>>,
