...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.edwinpai.com/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("edwinpai hooks list")}`,
      `  ${formatCliCommand("edwinpai hooks enable <name>")}`,
      `  ${formatCliCommand("edwinpai hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
