...
const ensureEdwinPAIModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveEdwinPAIAgentDir = vi.fn().mockReturnValue("/tmp/edwinpai-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/edwinpai-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureEdwinPAIModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveEdwinPAIAgentDir,
}));
