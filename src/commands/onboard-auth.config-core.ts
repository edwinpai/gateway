...
export function applyZaiConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyOpenrouterProviderConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyOpenrouterConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyMoonshotProviderConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyMoonshotConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyMoonshotConfigCn(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyKimiCodeProviderConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applySyntheticProviderConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
...
export function applyXiaomiProviderConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: EdwinPAIConfig): EdwinPAIConfig {
