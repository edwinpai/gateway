...
import { assertSandboxPath, assertNotSensitivePath } from "./sandbox-paths.js";
...
export function createSandboxedReadTool(root: string) {
  ...
  return wrapSandboxPathGuard(createEdwinPAIReadTool(base), root);
}
...
export function createEdwinPAIReadTool(base: AnyAgentTool): AnyAgentTool {
  ...
  return {
    ...
    execute: async (toolCallId, params, signal) => {
      ...
      // SECURITY (EDWIN-2026-003): Block reads to sensitive directories even without Docker sandbox
