...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveEdwinPAIAgentDir() returns mainAgentDir
    process.env.EDWINPAI_STATE_DIR = tmpDir;
    process.env.EDWINPAI_AGENT_DIR = mainAgentDir;
