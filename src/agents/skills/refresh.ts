...
function resolveWatchPaths(workspaceDir: string, config?: EdwinPAIConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: EdwinPAIConfig }) {
