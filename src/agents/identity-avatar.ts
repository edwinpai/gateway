...
function resolveAvatarSource(cfg: EdwinPAIConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: EdwinPAIConfig, agentId: string): AgentAvatarResolution {
