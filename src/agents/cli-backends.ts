...
// DEFAULT_CODEX_BACKEND removed — codex models route through OpenAI API
...
export function resolveCliBackendIds(cfg?: EdwinPAIConfig): Set<string> {
  const ids = new Set<string>([
    normalizeBackendKey("claude-cli"),
    // codex-cli removed — codex models route through OpenAI API
  ]);
