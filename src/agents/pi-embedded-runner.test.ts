...
beforeAll(async () => {
  ...
  tempRoot = await fs.mkdtemp(path.join(os.tmpdir(), "edwinpai-embedded-agent-"));
...
const ensureModels = (cfg: EdwinPAIConfig) => ensureEdwinPAIModelsJson(cfg, agentDir) as unknown;
