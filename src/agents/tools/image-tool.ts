...
function resolveDefaultModelRef(cfg?: EdwinPAIConfig): {
  provider: string;
  model: string;
} {
  if (cfg) {
...
function pickMaxBytes(cfg?: EdwinPAIConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const effectiveCfg: EdwinPAIConfig | undefined = params.cfg
    ? {
        ...params.cfg,
        agents: {
          ...params.cfg.agents,
  ...
  await ensureEdwinPAIModelsJson(effectiveCfg, params.agentDir);
