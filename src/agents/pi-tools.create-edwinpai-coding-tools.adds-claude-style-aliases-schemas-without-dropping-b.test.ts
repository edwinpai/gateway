...
describe("createEdwinPAICodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createEdwinPAICodingTools({
      config,
    ...
    const anthropicTools = createEdwinPAICodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createEdwinPAICodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createEdwinPAICodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
