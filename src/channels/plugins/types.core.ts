...
export type ChannelAgentToolFactory = (params: { cfg?: EdwinPAIConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: EdwinPAIConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: EdwinPAIConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: EdwinPAIConfig }) => boolean;
  supportsCards?: (params: { cfg: EdwinPAIConfig }) => boolean;
