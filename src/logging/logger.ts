...
export const DEFAULT_LOG_DIR = "/tmp/edwinpai";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "edwinpai.log"); // legacy single-file path

const LOG_PREFIX = "edwinpai";
...
function resolveSettings(): ResolvedSettings {
  let cfg: EdwinPAIConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => EdwinPAIConfig;
      };
