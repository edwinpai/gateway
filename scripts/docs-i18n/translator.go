...
func NewPiTranslator(srcLang, tgtLang string, glossary []GlossaryEntry, thinking string) (*PiTranslator, error) {
	...
	options.AppName = "edwin-docs-i18n"
	options.WorkDir = "/tmp"
...
- Keep product names in English: Edwin, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Edwin Gateway, use “Gateway 网关”.
